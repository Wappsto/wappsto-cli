...
class Wappsto {
    ...
    async createFile(version, file, path, count = 3) {
        try {
            ...
            console.log(JSON.stringify(response.data.file));
            ...
            if (err && err.response && err.response.data) {
                ...
                default:
                    /* istanbul ignore next */
                    tui.showError('Failed to create File', err);
                }
            } else {
                /* istanbul ignore next */
                tui.showError('Failed to create File', err);
    ...
    async updateFile(version, id, fileName) {
        try {
            ...
            /* istanbul ignore next */
            tui.showError('Failed to update File', err);
        }
    }
    ...
    async deleteFile(id) {
        try {
            ...
            default:
                /* istanbul ignore next */
                tui.showError('Failed to delete File', err);
            }
        }
    }
