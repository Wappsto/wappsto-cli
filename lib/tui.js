...
module.exports = {
    ...
    permissionRequest: (request, data) => {
        const msg = request.message ? `${request.message}:` :
              `Please choose the ${request.type} to share with ${request.name_installation}:`;
        const questions = [
            {
                name: 'permission',
                type: 'checkbox',
    ...
    askForNewWapp: () => {
        const questions = [
            ...
            },
            {
                ...
                when: (answer) => {
                    return answer.features.indexOf('foreground') != -1;
                },
            },
            {
                name: 'background',
                ...
                when: (answer) => {
                    return answer.features.indexOf('background') != -1;
                },
            },
            {
                name: 'examples',
